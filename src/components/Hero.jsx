    ...
    <div className="relative mx-auto flex max-w-7xl flex-col items-center justify-center px-4">
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between w-full gap-10">
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          <h1 className="text-3xl md:text-4xl lg:text-7xl font-bold text-gray-800 dark:text-gray-100">
          ...
          <motion.p
            ...
            className="mt-6 max-w-xl text-base md:text-lg font-normal text-gray-600 dark:text-gray-300"
          >
        ...
        >
          <motion.div
            ...
            className="rounded-3xl overflow-hidden shadow-md max-w-xl w-full bg-gray-100 dark:bg-gray-900"
          >
            <img
              src={imagem}
              alt="Foto de perfil"
